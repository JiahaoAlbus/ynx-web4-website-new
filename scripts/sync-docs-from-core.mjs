...
const docList = [
  ...
  { sourcePath: 'docs/en/PUBLIC_ASSET_STATUS.md', fallbackPath: '', category: 'Start Here', id: 'en/public-asset-status', title: 'Public Asset Status', language: 'en', description: 'Current official public-testnet asset status and mainstream asset targets.', tags: ['assets', 'trading', 'testnet'] },
  { sourcePath: 'docs/en/YUSD_TEST_ASSET_MANUAL.md', fallbackPath: '', category: 'Start Here', id: 'en/yusd-test-asset-manual', title: 'YUSD.test Asset Manual', language: 'en', description: 'Manual, risk boundaries, and commands for the YUSD.test synthetic test asset.', tags: ['assets', 'stablecoin', 'testnet'] },
  { sourcePath: 'docs/en/TESTNET_TRADING_MANUAL.md', fallbackPath: '', category: 'Start Here', id: 'en/testnet-trading-manual', title: 'Testnet Trading Manual', language: 'en', description: 'Commands and risk boundaries for the YNX testnet AMM trading pilot.', tags: ['trading', 'amm', 'testnet'] },
  { sourcePath: 'docs/en/PUBLIC_TESTNET_FEATURE_SECURITY_COMMANDS.md', fallbackPath: '', category: 'Start Here', id: 'en/public-testnet-feature-security-commands', title: 'Feature and Security Commands', language: 'en', description: 'Server-first acceptance commands for public-testnet features, AI, trading, bridge, and security checks.', tags: ['testnet', 'security', 'ai', 'trading'] },
  { sourcePath: 'docs/en/SPEED_FIRST_MULTI_ASSET_TRADING_PLAN.md', fallbackPath: '', category: 'Start Here', id: 'en/speed-first-multi-asset-trading-plan', title: 'Speed-First Multi-Asset Trading Plan', language: 'en', description: 'Speed-first trading direction and wrapped BTC/ETH/BNB/stablecoin roadmap.', tags: ['speed', 'trading', 'assets'] },
  ...
  { sourcePath: 'docs/zh/公开资产状态.md', fallbackPath: '', category: 'Chinese Docs', id: 'zh/public-asset-status', title: '公开资产状态', language: 'zh', description: '当前公开测试网资产状态与主流币目标。', tags: ['assets', 'trading', 'zh'] },
  { sourcePath: 'docs/zh/YUSD_test_资产手册.md', fallbackPath: '', category: 'Chinese Docs', id: 'zh/yusd-test-asset-manual', title: 'YUSD.test 资产手册', language: 'zh', description: 'YUSD.test 合成测试资产的手册、风险边界和命令。', tags: ['assets', 'stablecoin', 'zh'] },
  { sourcePath: 'docs/zh/测试网交易手册.md', fallbackPath: '', category: 'Chinese Docs', id: 'zh/testnet-trading-manual', title: '测试网交易手册', language: 'zh', description: 'YNX 测试网 AMM 交易 pilot 的命令和风险边界。', tags: ['trading', 'amm', 'zh'] },
  { sourcePath: 'docs/zh/公开测试网功能与安全测试命令.md', fallbackPath: '', category: 'Chinese Docs', id: 'zh/public-testnet-feature-security-commands', title: '公开测试网功能与安全测试命令', language: 'zh', description: '服务器优先的公开测试网功能、AI、交易、跨链和安全验收命令。', tags: ['testnet', 'security', 'ai', 'trading', 'zh'] },
  { sourcePath: 'docs/zh/极速优先多资产交易计划.md', fallbackPath: '', category: 'Chinese Docs', id: 'zh/speed-first-multi-asset-trading-plan', title: '极速优先多资产交易计划', language: 'zh', description: '极速优先交易方向和 wrapped 主流资产路线图。', tags: ['speed', 'trading', 'assets', 'zh'] },
