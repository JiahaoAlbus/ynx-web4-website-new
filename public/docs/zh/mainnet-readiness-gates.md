...
在宣称 BTC、ETH、BNB、USDT、USDC 或任何其他外部资产“可在 YNX 上交易”前，
必须满足：

- wrapped token 和 bridge route 有公开部署记录；
- YNX 目标网络上已有 bridge gateway；
- 充值和提现 smoke test 具备归档交易证据；
- signer / MPC / verification path 有文档且被监控；
- 单资产限额和紧急暂停开关就位；
- 流动性或做市路径已经上线；
- explorer / indexer 能正确展示该资产；
- 运营模型已获得法律/合规确认。

在此之前，准确表述应为：

`BTC、ETH、BNB、USDT、USDC 是 YNX 极速交易路线图中的目标资产，不是已经完成主网级就绪或真实外部资产正式可交易的结论。`
